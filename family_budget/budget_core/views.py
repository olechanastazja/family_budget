...
from budget_core.serializers import BudgetSerializer, BudgetItemSerializer, CategorySerializer
...
class BudgetItemViewSet(mixins.CreateModelMixin,
    ...
    def get_queryset(self):
        ...
        """
        user = self.request.user
        return BudgetItem.objects.filter(Q(budget__owner=user) | Q(budget__shared_with__id=user.id))
    ...
    def perform_destroy(self, instance):
        ...
        amount = -instance.amount if instance.item_type == BudgetItem.INCOME else instance.amount
